...
- **RESOLVED (2026-06-12 audit):** the spec was rewritten to use page-level `emulateMedia`; tsc exits 0. Closed by the FIX-09 audit pass.
...
- **RESOLVED (2026-06-12 audit):** unused import removed alongside the FIX-01 status-label a11y fix in the same file.
